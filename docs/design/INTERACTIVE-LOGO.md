...
The warm silhouette was sampled from the user-provided logo PNG, SHA-256 `01e061e72e24ad692ee7afe62f5ec8a9505c1a03b68bca213c2205ca853a5f32`, excluding its dark app-icon frame. It uses 941 colored dots in a 3,080-dot grid. The same coordinates/colors form the no-JavaScript SVG fallback and interactive canvas. This is a brand effect, not a playable video.
